...
public class ProyectoCalculadora extends JFrame implements ActionListener
   {   
	...
	JMenuBar contenedor;
	JMenu ver,ayuda ;
	JMenuItem estandar,cientifica,ver_ayuda;
    ...
    private ProyectoCalculadora() {
        throw new UnsupportedOperationException("Not supported yet."); 
          ...
          public void  iniciarControles()
          {
            ...
            //SETBOUNDS CAMBIA EL TAMAÑO DEL COMPONENTE
     ...
     public void actionPerformed(ActionEvent e)
	  {
		jTextField1.setFocusable(isFocusable());//desactiva el cursor al ingresar un valor
			...
			c=0;
                    ...
                    if(e.getSource()==ProyectoCalculadora.this.jButton9){ 
                        double k=1;
